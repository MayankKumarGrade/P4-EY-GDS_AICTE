      ...
      <div className="flex ldex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-10 text-sm">
        <div>
          ...
          <p className="w-full md:w-2/3 text-gray-600">
            We are an innovative e-commerce platform offering a wide range of
            high-quality products at affordable prices. Our mission is to
            provide a seamless shopping experience for customers all over the
            world. Join us in shaping the future of online shopping.
          </p>
        </div>
