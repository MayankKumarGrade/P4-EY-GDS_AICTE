    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 mt-32">
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center mt-2">
            ...
            <Star
              alt=""
              className="w-6 h-6 text-gray-400 fill-gray-400 opacity-25"
            />
          ...
          <p className="mt-5 text-gray-5500 md:w4/5">
          ...
          <button
            ...
            className="bg-black text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-800 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all duration-300 shadow-sm"
          >
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            An e-commerce platform offering a wide range of high-quality
            products at affordable prices. Our mission is to provide a seamless
            shopping experience for customers all over the world. Join us in
            shaping the future of online shopping
          </p>
          <p>
            E-commerce is to provide a seamless shopping experience for
            customers all over the world. Join us in shaping the future of
            online shopping
          </p>
        </div>
      </div>
